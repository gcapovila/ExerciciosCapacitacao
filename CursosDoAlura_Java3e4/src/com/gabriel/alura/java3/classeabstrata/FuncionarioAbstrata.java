...
public abstract class FuncionarioAbstrata {
	...
	public FuncionarioAbstrata(String nome, String cpf, String rg, double salario) {
		this.nome = nome;
		this.cpf = cpf;
		this.rg = rg;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FuncionarioAbstrata other = (FuncionarioAbstrata) obj;
		if (cpf == null) {
			if (other.cpf != null)
				return false;
